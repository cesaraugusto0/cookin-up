<template>
    <header class="banner">
        <div class="apresentacao">
            <img src="../assets/imagens/logo.svg" alt="Logo do Cookin' Up" class="texto-verde">
        ...
        <img src="../assets/imagens/foto-banner.png" alt="Fotos de uma mulher cozinhando" class="foto-banner">
    </header>
</template>
